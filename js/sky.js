function init() {
  (container = document.getElementById("canvas")),
    ...
    ((scene = new THREE.Scene({ antialias: !0 })).fog = new THREE.FogExp2(
      1776411,
      1e-4
    )),
    starForge(),
...
function render() {
  (camera.position.x += 0.005 * (mouseX - camera.position.x)),
    (camera.position.y += 0.005 * (-mouseY - camera.position.y)),
